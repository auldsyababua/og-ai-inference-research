...
- ✅ Correct: `http://workhorse.local/lab/tree/og-ai-inference-research/tools/unified-calculator.ipynb`
- ❌ Wrong: `http://workhorse.local/lab/tree/tools/unified-calculator.ipynb`
...
1. Open JupyterLab: `http://workhorse.local/lab/`
2. Use file browser (left sidebar)
3. Navigate: `og-ai-inference-research` → `tools` → `unified-calculator.ipynb`
